    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/paiements/circuit/paypal/create-order").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/paiements/circuit/paypal/capture-order").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/paiements/circuit-personnalise/paypal/config").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/paiements/circuit-personnalise/paypal/create-order").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/paiements/circuit-personnalise/paypal/capture-order").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/circuits-personnalises/me").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/circuits-personnalises/me/**").authenticated()
