CREATE TABLE IF NOT EXISTS paiements_reservation_hebergement (
...
CREATE INDEX IF NOT EXISTS idx_paiements_hebergement_reservation
    ON paiements_reservation_hebergement(reservation_hebergement_id);

CREATE INDEX IF NOT EXISTS idx_paiements_hebergement_order
